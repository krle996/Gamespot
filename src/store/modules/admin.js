...
const FbApiKey = "AIzaSyDHOYP4Hp3dvznS5Bu-WoWcPBrkbJcPqpc";
...
const admin = {
    ...
    actions:{
        ...
        imageUpload({commit},file){
            const CLOUDINARY_URL = 'https://api.cloudinary.com/v1_1/dpb88svrv/image/upload';
            const CLOUDINARY_PRESET = 'cvezdid7'
